...
public class Persona {
    ...
    public Persona(Long id, Integer perscons, Integer persaror, Integer persopid, Integer perstipo, String persnomb, Integer perstiid, String persiden, String persusop, String persusua, String persesta, String persuscr, String persfecr, String unoppers, String peuopers) {
        this.id = id;
    ...
    public List<OrdePers> getOrdePers() {
        if (ordePers == null) {
            ...
            List<OrdePers> ordePersNew = targetDao._queryPersona_OrdePers(id);
            synchronized (this) {
                if(ordePers == null) {
