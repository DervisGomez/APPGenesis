...
/** 
 * DAO for table TURN_UNID_MEDI.
*/
public class TurnUnidMediDao extends AbstractDao<TurnUnidMedi, Long> {

    public static final String TABLENAME = "TURN_UNID_MEDI";

    /**
     * Properties of entity TurnUnidMedi.<br/>
    ...
    */
    ...
    public TurnUnidMediDao(DaoConfig config) {
        super(config);
    }
    
    public TurnUnidMediDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'TURN_UNID_MEDI' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'TURN_UNID_MEDI'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TurnUnidMedi entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public TurnUnidMedi readEntity(Cursor cursor, int offset) {
        TurnUnidMedi entity = new TurnUnidMedi( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, TurnUnidMedi entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(TurnUnidMedi entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(TurnUnidMedi entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
