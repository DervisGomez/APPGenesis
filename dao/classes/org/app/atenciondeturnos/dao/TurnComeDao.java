...
/** 
 * DAO for table TURN_COME.
*/
public class TurnComeDao extends AbstractDao<TurnCome, Long> {

    public static final String TABLENAME = "TURN_COME";

    /**
     * Properties of entity TurnCome.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property IdTurn = new Property(11, Long.class, "idTurn", false, "ID_TURN");
    };

    private Query<TurnCome> gDB_TURNOS_ComentarioQuery;

    public TurnComeDao(DaoConfig config) {
        super(config);
    }
    
    public TurnComeDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'TURN_COME' (" + //
                ...
                "'ID_TURN' INTEGER);"); // 11: idTurn
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'TURN_COME'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TurnCome entity) {
        stmt.clearBindings();
        ...
        Long idTurn = entity.getIdTurn();
        if (idTurn != null) {
            stmt.bindLong(12, idTurn);
        }
    }
    ...
    /** @inheritdoc */
    @Override
    public TurnCome readEntity(Cursor cursor, int offset) {
        TurnCome entity = new TurnCome( //
            ...
            cursor.isNull(offset + 11) ? null : cursor.getLong(offset + 11) // idTurn
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, TurnCome entity, int offset) {
        ...
        entity.setIdTurn(cursor.isNull(offset + 11) ? null : cursor.getLong(offset + 11));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(TurnCome entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(TurnCome entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    /** Internal query to resolve the "comentario" to-many relationship of GDB_TURNOS. */
    public List<TurnCome> _queryGDB_TURNOS_Comentario(Long idTurn) {
        synchronized (this) {
            if (gDB_TURNOS_ComentarioQuery == null) {
                QueryBuilder<TurnCome> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.IdTurn.eq(null));
                gDB_TURNOS_ComentarioQuery = queryBuilder.build();
            }
        }
        Query<TurnCome> query = gDB_TURNOS_ComentarioQuery.forCurrentThread();
        query.setParameter(0, idTurn);
        return query.list();
    }
