...
/** 
 * DAO for table TURN_MATE.
*/
public class TurnMateDao extends AbstractDao<TurnMate, Long> {

    public static final String TABLENAME = "TURN_MATE";

    /**
     * Properties of entity TurnMate.<br/>
    ...
    */
    ...
    public TurnMateDao(DaoConfig config) {
        super(config);
    }
    
    public TurnMateDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'TURN_MATE' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'TURN_MATE'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TurnMate entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(TurnMate entity) {
    ...
    /** @inheritdoc */
    @Override
    public TurnMate readEntity(Cursor cursor, int offset) {
        TurnMate entity = new TurnMate( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, TurnMate entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(TurnMate entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(TurnMate entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
